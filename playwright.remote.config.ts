...
export default defineConfig({
  ...
  testMatch: ["messaging-remote-ui.spec.ts", "social-feed-remote-ui.spec.ts", "client-profile-remote-ui.spec.ts", "admin-access-remote-ui.spec.ts", "continuous-real-acceptance.spec.ts", "preview-health.spec.ts"],
  workers: 1,
  fullyParallel: false,
  reporter: "list",
  use: {
