...
const proModules = [
  ...
  module("videos", "Vidéos", "▶", "Contenu", "Publication, brouillons, programmation et statistiques.", { resource: "videos" }),
...
const superAdminModules = [
  ...
  module("videos", "Vidéos", "▶", "Réseau social", "Vidéos publiées et modérées.", { permission: "content.manage", resource: "videos" }),
